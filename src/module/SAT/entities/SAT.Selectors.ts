export enum SAT_SELECTORS_NOTES {
  ...
  district = '#conteudo_lblBairroEmitente',
  zipCode = '#conteudo_lblCepEmitente',
  city = '#conteudo_lblMunicipioEmitente',
  cnpj = '#conteudo_lblCnpjEmitente',
  ie = '#conteudo_lblIeEmitente',
